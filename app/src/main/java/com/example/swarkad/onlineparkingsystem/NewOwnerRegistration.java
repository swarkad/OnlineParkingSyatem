...
public class NewOwnerRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_owner_registration);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(NewOwnerRegistration.this,MainActivity.class);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(NewOwnerRegistration.this, fullName.getText().toString(), Toast.LENGTH_SHORT);
                ...
                if(!(fullname1.equals("")) && !(fullname1.equals(null)) && !(mobile1.equals("")) && !(mobile1.equals(null)) &&
                        ...
                        !(aadharno1.equals("")) && !(aadharno1.equals(null)) && !(space1.equals("")) && !(space1.equals(null)) &&
                        !(username1.equals("")) && !(username1.equals(null)) && !(password1.equals("")) && !(password1.equals(null))&&
                        !(panno1.equals("")) && !(panno1.equals(null)))
                {

                    String str = "OwnerUserRegistration";
                    BackgroundTask backgroundTask = new BackgroundTask(getApplicationContext());
                    backgroundTask.execute(str, fullname1, mobile1, email1, address1, aadharno1, panno1, space1, username1, password1, " "+currentTime);
                    finish();
                }
                else
                {
                    Toast.makeText(NewOwnerRegistration.this,"please all information",Toast.LENGTH_SHORT).toString();
                    timeAlertDialog();
