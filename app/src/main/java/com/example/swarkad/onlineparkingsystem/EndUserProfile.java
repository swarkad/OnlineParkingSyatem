...
public class EndUserProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showMapButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EndUserProfile.this,MapsActivity.class);
...
//                startActivity(intent);
                ...
                Intent intent = new Intent(EndUserProfile.this,OwnerUserList.class);
                intent.putExtra("data", json_data);
                startActivity(intent);
